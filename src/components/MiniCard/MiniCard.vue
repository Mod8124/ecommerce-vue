<template>
    <div class="nav__list nav__list--mobile">
                        ...
                        <div class="nav__listCartNotEmpty" v-if="shoes.length>0">
                            ...
                            <div class="nav__listShopping" v-for="(shoe,index) in shoes" :key="index"><!--nav__listShopping-->
                                    ...
                                    <div class="nav__listShoppingDetails">
                                        ...
                                        <p class="nav__listShoppingPrices">${{shoe.price}} x {{shoe.count}} <span class="nav__listShoppingPrices nav__listShoppingPrices--strong">${{parseInt(shoe.price * shoe.count).toFixed(2)}}</span> </p>
                                    </div>

                                    <div class="nav__iconDelete">
                                         <button @click="deleteShoes(index)" class="nav__listShoppingDelete"><img src="@/assets/images/icon-delete.svg" alt="icon-delete" class="nav__listShoppingDeleteIcon"></button>
                                    </div>
...
export default {
    ...
    setup() {
        ...
        const deleteShoes = (index) => store.commit('deleteShoes',index)
